            ...
            return (
              ...
              >
                {metodo.logoUrl ? (
                  ...
                  <span className="px-1 text-center text-[10px] font-extrabold text-slate-700 dark:text-slate-300 sm:px-2 sm:text-xs">
                    {metodo.banco}
                  </span>
                )}
                {isSelected && (
  ...
  return (
    <div className="mt-3">
      ...
      <div className="mt-1 flex items-center gap-2">
        <span className="min-w-0 flex-1 break-all rounded-xl bg-white px-3 py-2 text-sm font-black tracking-wide text-slate-900 shadow-sm dark:bg-slate-950/60 dark:text-white sm:text-base md:text-lg">
          {value}
        </span>
        <button
          type="button"
